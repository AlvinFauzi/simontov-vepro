...
@section('content')
            ...
            <div class="card ">
                <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="javascript:void(0);" class="btn-filter" data-bs-placement="top" data-bs-toggle="tooltip"
                            title="Refresh Chart">
                ...
                <div class="card-body pb-0">
                    <h5 id="chart-date-range" class="text-center fw-bold">
                    </h5>
                    <h5 id="loading-text" class="text-center fw-bold">
                        {{ trans('lang.please-wait') }}
                    </h5>
    ...
    <div class="row mb-2" id="other-chart">
        <div class="col-12">
            <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <div class="progress h-1 mt-0 mb-2">
                                        <div class="progress-bar progress-bar-striped bg-primary w-100" role="progressbar">
                                        </div>
                                    </div>
                                    <div class="row mt-4">
