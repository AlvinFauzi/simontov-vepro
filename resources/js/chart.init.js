...
chartBarColors = getChartColorsArray("line_chart_annotations"), options = {
    series: [{
...
chartBarColors = getChartColorsArray("syncingchart-line"), options = {
    series: [{
...
chartBarColors = getChartColorsArray("line_chart_realtime"), options = {
    series: [{
        data: data.slice()
    }],
    chart: {
